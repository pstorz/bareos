...
static const ResourceItem client_items[] = {
  ...
  { "Password", CFG_TYPE_AUTOPASSWORD, ITEM(res_client, password_), {config::Alias{"FdPassword"}}},
  { "ScramPassword", CFG_TYPE_CLEARPASSWORD, ITEM(res_client, password_), {config::Description{"Cleartext password for SCRAM-SHA-256 authentication."}}},
...
static const ResourceItem store_items[] = {
  ...
  { "Password", CFG_TYPE_AUTOPASSWORD, ITEM(res_store, password_), {config::Alias{"SdPassword"}}},
  { "ScramPassword", CFG_TYPE_CLEARPASSWORD, ITEM(res_store, password_), {config::Description{"Cleartext password for SCRAM-SHA-256 authentication."}}},
