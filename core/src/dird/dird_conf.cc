...
static const ResourceItem dir_items[] = {
  ...
  { "SubscriptionFile", CFG_TYPE_DIR, ITEM(res_dir, subscription_file), {config::Description{"Optional path to the signed Bareos subscription file. If omitted, the director will look for the packaged default path."}}},
